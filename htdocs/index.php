...
<?php if (empty($formViews) || !$is_connection_ready) { ?>
    <div class="select-form-container align-center welcome-container">
	   ...
	   <?php if ($is_connection_ready != false){?>
       <h3 class="welcome-text">Welcome to the E-digit PHP form builder version 2.0. You have not yet created any forms. Click the button below to begin</h3>
	   <a href="<?php echo $docRoot; ?>/actions.php?a=create" class="hyperlink-button light-blue-button welcome-button">Create Form</a>	   
	   <?php }else{?>
	   <h3 class="welcome-text">Welcome to the E-digit PHP form builder version 2.0. Setup your database to begin creating forms</h3>
	   <?php }?>
    </div>
<?php 
}else{
